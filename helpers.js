(function() {
  ...
  module.exports = {
    loadConfig: function(cb) {
      var callback, config, configpath, err, pathArr, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
                  ...
                  if (config) {
                    ...
                    (function(__iced_k) {
                      if ((pathArr.length - 2) >= 0) {
                        return __iced_k(_.pullAt(pathArr, pathArr.length - 2));
                      } else {
                        (function(__iced_k) {
_break()
                        })(__iced_k);
                      ...
                      return __iced_k(configpath = '/' + path.join.apply(_this, pathArr));
                    });
                  }
                })(_next);
              });
