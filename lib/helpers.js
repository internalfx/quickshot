(function() {
  ...
  module.exports = {
    ...
    getShopProducts: function(target, cb) {
      var chunkSize, err, page, products, productsBody, res, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      chunkSize = 250;
      page = 1;
          ...
          _while = function(__iced_k) {
            ...
            if (productsBody.products.length === 0) {
              ...
              (function(__iced_k) {
                ...
                page += 1;
                return _next(console.log("Products downloaded: " + products.length));
              });
            }
          };
          _while(__iced_k);
