(function() {
  var colors, fs, helpers, iced, inquirer, mfs, moment, path, request, shopifyQueue, __iced_k, __iced_k_noop;
  ...
  shopifyQueue = {
    ...
    run: function() {
      var exponent, headroom, ___iced_passed_deferral, __iced_deferrals, __iced_k, _next;
  ...
  helpers = {
    ...
    getShopPages: function(target, cb) {
      var chunkSize, err, page, pages, pagesBody, res, ___iced_passed_deferral, __iced_deferrals, __iced_k, _next;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      chunkSize = 250;
      page = 1;
    ...
    log: function(text, color) {
      ...
      return console.log(colors[color]("" + (helpers.ts()) + " - " + text));
    }
  };
