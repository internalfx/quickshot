(function() {
  ...
  exports.run = function(argv, done) {
    var config, err, filter, pages, target, walker, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    ...
    (function(_this) {
      return (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          ...
          filename: "/home/bmorris/ownCloud/projects/quickshot/src/pages/upload.iced",
          funcname: "run"
        });
                  ...
                  (function(__iced_k) {
                    if (page) {
                      ...
                      (function(__iced_k) {
                        ...
                        return __iced_k(helpers.log("Created new Page with handle " + fileHandle + "...", 'yellow'));
                      });
                    }
                  })(function() {
                    if (typeof err === "undefined" || err === null) {
                      return helpers.log("Uploaded " + filepath, 'green');
                    }
                  });
                };
              })(this));
