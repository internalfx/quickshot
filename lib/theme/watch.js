(function() {
  var chokidar, cjsx, coffee, colors, fs, helpers, iced, inquirer, mkdirp, parser, path, request, sass, __iced_k, __iced_k_noop;
        ...
        (function(__iced_k) {
          ...
          (function(__iced_k) {
            ...
            watcher.on('all', function(event, filepath) {
              var assetsBody, compiledSource, data, err, extension, mainscss, res, result, source, sourceCjsx, sourceCoffee, targetscss, ___iced_passed_deferral1, __iced_deferrals, __iced_k;
              __iced_k = __iced_k_noop;
                  ...
                  (function(_this) {
                    ...
                    return function() {
                      (function(__iced_k) {
                        ...
                        (function(__iced_k) {
                          if (config.compile_coffeescript && filepath.match(/\.cjsx$/)) {
                            ...
                            (function(__iced_k) {
                              ...
                              fs.readFile(sourceCjsx, 'utf8', __iced_deferrals.defer({
                                assign_fn: (function() {
                                  return function() {
                                    err = arguments[0];
                                    return source = arguments[1];
                              ...
                              (function(__iced_k) {
                                ...
                                fs.writeFile(sourceCjsx.replace('.cjsx', '.js'), compiledSource, __iced_deferrals.defer({
                                  assign_fn: (function() {
                                    return function() {
                                      return err = arguments[0];
                                    };
