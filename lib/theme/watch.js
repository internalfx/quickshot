(function() {
  var chokidar, coffee, colors, fs, helpers, iced, inquirer, mkdirp, parser, path, request, sass, __iced_k, __iced_k_noop;
        ...
        (function(__iced_k) {
          ...
          (function(__iced_k) {
            ...
            watcher.on('all', function(event, filepath) {
              var assetsBody, compiledSource, data, err, extension, mainscss, res, result, source, sourceCoffee, targetscss, ___iced_passed_deferral1, __iced_deferrals, __iced_k;
              __iced_k = __iced_k_noop;
