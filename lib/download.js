(function() {
  ...
  exports.run = function(argv, done) {
    var config, err, filter, ignore, target, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      return function() {
        ...
        (function(__iced_k) {
          ...
          (function(__iced_k) {
            ...
            (function(cb) {
              var err, key, page, pages, ___iced_passed_deferral1, __iced_deferrals, __iced_k;
              __iced_k = __iced_k_noop;
                    ...
                    for (_i = 0, _len = assets.length; _i < _len; _i++) {
                      ...
                      if ((filter == null) || key.match(new RegExp("^" + filter))) {
                        (function(cb, asset, key) {
                          var data, err, rawData, res, ___iced_passed_deferral2, __iced_deferrals, __iced_k;
                          __iced_k = __iced_k_noop;
