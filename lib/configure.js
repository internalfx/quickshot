(function() {
  var colors, configureCoffeeScript, configureIgnoreFile, configureScss, configureTargets, fs, helpers, iced, inquirer, mfs, request, __iced_k, __iced_k_noop;
                ...
                inquirer.prompt([
                  {
                    ...
                    name: 'action',
                    message: 'Main Menu',
                    choices: ['Configure targets', 'Configure scss', 'Configure CoffeeScript', 'Configure ignore file', 'Save configuration and exit']
                  }
