(function() {
  ...
  exports.run = function(argv, done) {
    var assetsBody, config, err, filter, ignore, metaData, metaJson, metafield, newProdData, prodData, prodImage, prodJson, prodPath, productDir, productDirs, res, target, ___iced_passed_deferral, __iced_deferrals, __iced_k, _next;
                ...
                (function(__iced_k) {
                  ...
                  (function(__iced_k) {
                    ...
                    _fn = function(prodImage, cb) {
                      var image, imgData, newVariant, newVariantIds, requestBody, res, variant_id, ___iced_passed_deferral1, __iced_deferrals, __iced_k, _k, _len2, _ref2;
                      __iced_k = __iced_k_noop;
                    ...
                    (function(__iced_k) {
                      ...
                      (function(__iced_k) {
                        ...
                        return _next(helpers.log("Created " + newProdData.handle, 'green'));
                      });
                    });
                  });
                });
