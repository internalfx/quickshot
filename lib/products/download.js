(function() {
  ...
  exports.run = function(argv, done) {
    var config, err, filter, ignore, page, product, products, productsBody, productsDownloaded, res, target, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    ...
    (function(_this) {
      return (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          ...
          filename: "/home/bmorris/ownCloud/projects/quickshot/src/products/download.iced",
          funcname: "run"
        });
                            ...
                            (function(__iced_k) {
                              ...
                              (function(__iced_k) {
                                ...
                                (function(__iced_k) {
                                  ...
                                  (function(__iced_k) {
                                    var _j, _len1, _ref, _results1, _while;
                                    _ref = product.images;
                                    _len1 = _ref.length;
                                    _j = 0;
                                    _results1 = [];
